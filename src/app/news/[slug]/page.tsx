...
import { ChevronLeft, Share2 } from 'lucide-react'; // Removed failing brand icons
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';

// Define Brand Icons locally to avoid Lucide-react import errors
      ...
      <div className="max-w-[1000px] mx-auto px-6 mb-16">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-y border-gray-100 py-6 gap-6">
          ...
          <div className="flex items-center gap-5">
            <button className="text-gray-300 hover:text-[#0077b5]"><LinkedinIcon size={18} /></button>
            <button className="text-gray-300 hover:text-[#1DA1F2]"><TwitterIcon size={18} /></button>
            <button className="text-gray-300 hover:text-[#4267B2]"><FacebookIcon size={18} /></button>
