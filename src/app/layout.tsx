    ...
    <html lang="en">
      <body className="antialiased bg-white text-[#0D243F]">
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-[999] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:bg-[#128C7E] transition-all duration-300 group flex items-center justify-center animate-bounce-slow"
          aria-label="Contact TexLube on WhatsApp"
        >
          {/* WhatsApp SVG Icon */}
          ...
          {/* Subtle Glow Ring */}
          <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-20 group-hover:animate-ping"></span>
        </a>
